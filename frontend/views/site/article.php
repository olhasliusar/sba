...
?>
<svg style="display: none;" width="0" height="0" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-xs-12">
                <article>
                    <h2 class="article__title tac"><?= $article->name ?></h2>
                    ...
                    <?php if ($article->video) {
                        echo $this->render('item/_youtube', [
                            'model' => $article,
                        ]);
                    } ?>
                </article>
                ...
                <div class="section__comments">
                    ...
                    <script type="text/javascript">
                        VK.Widgets.Comments("vk_comments", {limit: 15, width: "750", attach: "*"});
                    </script>
            ...
            <div class="col-md-4 col-xs-12">
                <h2 class="sidebar__title"><?= \Yii::t('general', 'All articles') ?></h2>
                
                <?= $this->render('item/_articles-sidebar', [
                        'models' => $articles,
                    ]); ?>                
            </div>
        </div>
